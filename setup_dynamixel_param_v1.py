...
import sys
sys.path.append("/home/ubuntu/practice_ws/src/dynamixel_motor/dynamixel_controllers/src/dynamixel_controllers")
...
jtc[2].set_compliance_slope(32)
jtc[2].set_compliance_punch(32)

jtc[4].set_compliance_margin(0)
jtc[4].set_compliance_slope(32)
jtc[4].set_compliance_punch(32)
